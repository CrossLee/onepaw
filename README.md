...
| 平台 | 最新已发布版本 | 安装包 | 发布状态 |
| :--- | :--- | :--- | :--- |
| macOS 14+ · Apple Silicon / Intel | [0.6.10](https://github.com/CrossLee/onepaw/releases/tag/v0.6.10) | **[下载 DMG](https://github.com/CrossLee/onepaw/releases/download/v0.6.10/OnePaw-0.6.10-macos-universal2.dmg)** | Developer ID 签名 · Apple 公证 |
...
Mac 备用安装方式：[PKG](https://github.com/CrossLee/onepaw/releases/download/v0.6.10/OnePaw-0.6.10-macos-universal2.pkg) · [ZIP](https://github.com/CrossLee/onepaw/releases/download/v0.6.10/OnePaw-0.6.10-macos-universal2.zip)。版本信息更新于 **2026-09-15**。
...
**从旧名称升级到一爪，请下载 0.6.10 的 PKG。** PKG 会先校验和备份原应用，再归档旧名称实体；请勿提前删除旧应用或用户数据。DMG/ZIP 不自动迁移旧名称，直接拖入可能留下两个应用目录。
